...
The original sprint-by-sprint build history for Collective Brain, preserved from
the first README. For the project overview, see the [main README](../README.md).
